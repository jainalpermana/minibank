      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#about"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Transaksi</a></li>
            <li><a href="#about"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Laporan</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li><a href="../navbar-static-top/"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Profile</a></li>
            <li class="active">
